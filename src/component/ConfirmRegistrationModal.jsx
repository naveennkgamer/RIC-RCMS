        ...
        >
            <DialogTitle>
                <Box display="flex" flexDirection="column" alignItems="flex-start" gap="15px">
                    ...
                    <Typography variant="h6" sx={{ fontFamily: "Manrope", fontWeight: "400" }} >
            ...
            <DialogContent>
                <Typography sx={{ fontFamily: "Manrope", fontWeight: "normal" }}>
            ...
            <DialogActions sx={{ justifyContent: "space-between", px: 3, pb: 2, borderTop: "1px solid #E4E4E4", paddingTop: "20px", "@media (max-width: 450px)": { flexDirection: "column", gap: "5px", }, }}>
                <Button onClick={onClose} sx={{ color: "#3A2B65", textTransform: "none", fontFamily: "Manrope", fontWeight: "400", fontSize: "18px" }}>
                    Back to Registration
                </Button>
                <Button variant="contained" sx={{ backgroundColor: "#3A2B65", textTransform: "none", padding: "8px 25px", fontFamily: "Manrope", fontWeight: "400", fontSize: "18px", "@media (max-width: 450px)": { width: "80%" }, }} onClick={onConfirm}>
                    Generate OTP
                </Button>
            </DialogActions>
        </Dialog>
